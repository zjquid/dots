...
static const int smartgaps	    = 1;	/* 1 = one window no gaps, 0 = one window gaps */
...
static const char col_orange[]      = "#ff6a13";
...
static const char *firefoxrun[] = { "firefox", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_r,      spawn,          {.v = dmenucmd } },
	{ MODKEY,	                XK_Return, spawn,          {.v = termcmd } },
	{ MODKEY,                       XK_b,      spawn,     	   {.v = firefoxrun } },
